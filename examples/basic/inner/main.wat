(module
  ...
  (func $_reflect.Type_.Align (type 4) (param i32) (result i32)
    ...
    i32.const 0
    i32.load offset=75976
    local.set 2
    i32.const 0
    local.get 1
    i32.const 40
    i32.add
    i32.store offset=75976
    local.get 1
    local.get 2
    i32.store offset=40
    block  ;; label = @1
  ...
  (func $github.com/fizx/goingo/inner.main (type 5) (param i32 i32)
    ...
    block  ;; label = @1
      block  ;; label = @2
        ...
        local.get 4
        i32.const 0
        i32.load8_u offset=75785
        i32.const 0
        i32.load8_u offset=75784
        i32.add
        i32.const 3
        i32.shl
        i32.const 12
        ...
        i32.const 0
        i32.const 0
        i32.load offset=75780
        i32.const 1
        i32.add
        i32.store offset=75780
        local.get 4
        local.get 2
        i32.const 8
        i32.add
  ...
  (func $github.com/fizx/stubproto/fmt.Errorf (type 11) (param i32)
    ...
    i32.add
    global.set 0)
  (func $github.com/fizx/goingo/examples/basic/proto.sovTest (type 16) (param i64) (result i32)
    local.get 0
    i64.const 1
    i64.or
    ...
    i32.const 7
    i32.div_s)
  (func $github.com/fizx/goingo/pack.ResponseCopy (type 6) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32)
    global.get 0
    i32.const 144
    i32.sub
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        ...
        block  ;; label = @3
          ...
          i32.const 10213
          local.get 10
          call $github.com/fizx/goingo/pack.ResponseCopy
        end
        local.get 0
        i32.const 160
        i32.add
              ...
              block  ;; label = @6
                block  ;; label = @7
                  ...
                  block  ;; label = @8
                    ...
                    local.get 12
                    i64.extend_i32_u
                    call $github.com/fizx/goingo/examples/basic/proto.sovTest
                    i32.add
                    i32.const 1
                    i32.add
                    local.set 10
